...
return [
    ...
    'attributes'           => [
        ...
        'kk_user_email_or_kk_user_phone'     => 'E-mail или Номер телефона',

        'kk_user_firstname'     => 'Имя',
        'kk_user_lastname'      => 'Фамилия',
        ...
        'kk_user_role_id' => 'Роль Пользователя',
        ...
        'kk_user_password_privacy_politic_confirmation' => 'Согласие на обработку персональных данных',

        'kk_support_name' => 'Имя',
        'kk_support_email' => 'E-mail',
        'kk_support_subject' => 'Тема',
        'kk_support_message' => 'Сообщение',

        'kk_course_id' => 'ID Курса',
        'kk_course_categoty_id' => 'Категория',
        'kk_course_name' => 'Название',
        'kk_course_description' => 'Описание',
        'kk_course_image' => 'Изображение',

        'kk_lesson_course_id' => 'ID Курса',
        'kk_lesson_name' => 'Название',
        'kk_lesson_description' => 'Описание',
        'kk_lesson_text' => 'Текст',
        'kk_lesson_audio' => 'Аудиоверсия',

        'kk_question_lesson_id' => 'ID Урока',
