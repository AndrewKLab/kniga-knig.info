    ...
    return isOpen ?
        <Modal centered isOpen={isOpen} setIsOpen={setIsOpen}>
            <Form onSubmit={handleSubmit(onSubmitDonateForm)}>
                ...
                <ModalActions>
                    <Button className={'lesson_page_button'} color={'primary'} type={`submit`} style={{ padding: '10px 15px' }}>Пожервовать</Button>
                </ModalActions>
            </Form>
        </Modal> : null
}
