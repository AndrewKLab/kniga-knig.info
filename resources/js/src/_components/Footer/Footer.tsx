...
export const Footer: FunctionComponent<FooterProps> = ({ children, className }): JSX.Element => {
    ...
    const SocialIcons = () => {
        return <React.Fragment>
            <a href={`https://www.youtube.com/@golosnadezhdi`} target="_blank"><IconButton icon={<YouTubeIcon />} /></a>
            <a href={`https://vk.com/golosnadezhdi`} target="_blank"><IconButton icon={<VKIcon />} /></a>
            <a href={`https://ok.ru/golosnadezhdi`} target="_blank"><IconButton icon={<OKIcon />} /></a>
        </React.Fragment>
    }
    return (
