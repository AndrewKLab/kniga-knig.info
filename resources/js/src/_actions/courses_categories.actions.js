...
function getAll(params) {
    return dispatch => {
        ...
        return coursesCategoriesService.getAll(params)
            .then(
    ...
    function request(params) { return { type: coursesCategoriesConstants.GET_ALL_COURSES_CATEGORIES_REQUEST, params } }
    function success(res) { return { type: coursesCategoriesConstants.GET_ALL_COURSES_CATEGORIES_SUCCESS, res } }
    function failure(error) { return { type: coursesCategoriesConstants.GET_ALL_COURSES_CATEGORIES_FAILURE, error } }
}
