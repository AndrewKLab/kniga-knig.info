export const ru = {
    assetManager: {
        addButton: 'Добавить',
        inputPlh: 'https://kniga-knig.info/assets/img/site/image.jpg',
    ...
    blockManager: {
        labels: {
            ...
            map: 'Карта',
            quote: 'Цитата',
            'link-block': 'Блок ссылки',
            'text-section': 'Текстовая секция',
            divider: 'Разделитель',
            'grid-items': 'Сетка',
            'list-items': 'Список',
            tooltip: 'Подсказка',
    ...
    styleManager: {
        ...
        properties: {
            ...
            'background-repeat-sub': 'Повторить',
            ...
            'transition-duration-sub': 'Длительность',
            'transition-timing-function-sub': 'Расчет времени',
