...
type MyCoursesModulesListProps = { 
    dispatch: any; 
    user: User; 
...
const MyCoursesModulesList: FunctionComponent<MyCoursesModulesListProps> = ({ 
    dispatch, 
    user,
...
const connectedMyCoursesModulesList = connect(mapStateToProps)(MyCoursesModulesList);
export { connectedMyCoursesModulesList as MyCoursesModulesList };