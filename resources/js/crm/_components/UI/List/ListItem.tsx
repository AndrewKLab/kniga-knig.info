...
export interface ListItemProps extends React.HTMLAttributes<HTMLDivElement> {
    ...
    itemDropdownActive?: boolean;
    itemDropdown?: React.ReactNode;
    itemRightComponentClassName?: string;
    renderDivider?: boolean;
    renderBorder?: boolean;
}

export const ListItem: FunctionComponent<ListItemProps> = ({ children, className, itemType, itemAvatar, itemAvatarClassName, itemTitle, itemTitleClassName, itemDescription, itemRightComponent, itemRightComponentClassName, renderDivider, renderBorder, itemDropdown, itemDropdownActive, ...other }): JSX.Element => {
    return (
        <React.Fragment>
            ...
            {itemDropdownActive && itemDropdown}
            </React.Fragment>
    )
}   