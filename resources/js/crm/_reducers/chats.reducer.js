...
const initialState = {
    ...
    create_chats_loading: false,
    create_chats_message:null,
    create_chats_error: null,
    create_chats: null,
    ...
    switch (action.type) {
        ...
        case chatsConstants.GET_ALL_BY_USER_CHATS_FAILURE:
            return {
                ...
                get_all_by_user_chats_loading: false,
                get_all_by_user_chats_message: null,
                get_all_by_user_chats_error: action.error.message,
                get_all_by_user_chats: null,
            };
        ...
        case chatsConstants.GET_ONE_BY_ID_CHATS_FAILURE:
            return {
                ...
                get_one_by_id_chats_loading: false,
                get_one_by_id_chats_message: null,
                get_one_by_id_chats_error: action.error.message,
                get_one_by_id_chats: null,
            };
        ...
        case chatsConstants.SEND_MESSAGE_CHATS_FAILURE:
            return {
                ...
                send_message_chats_loading: false,
                send_message_chats_message: null,
                send_message_chats_error: action.error.message,
                send_message_chats: null,
            };
        // CREATE_CHATS
        case chatsConstants.CREATE_CHATS_REQUEST:
            return {
                ...state,
                create_chats_loading: true,
                create_chats_message: null,
                create_chats_error: null,
                create_chats: null,
            };
        case chatsConstants.CREATE_CHATS_SUCCESS:
            return {
                ...state,
                create_chats_loading: false,
                create_chats_message: action.res.message,
                create_chats_error: null,
                create_chats: action.res.chat,
                
                // get_one_by_id_chats: state.get_one_by_id_chats && state.get_one_by_id_chats.messages ? {...state.get_one_by_id_chats, messages: [...state.get_one_by_id_chats.messages, action.res.message]}  : state.get_one_by_id_chats,
            };
        case chatsConstants.CREATE_CHATS_FAILURE:
            return {
                ...state,
                create_chats_loading: false,
                create_chats_message:null,
                create_chats_error: action.error.message,
                create_chats: null,
            };
