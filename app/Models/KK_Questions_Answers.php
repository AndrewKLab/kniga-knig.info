...
class KK_Questions_Answers extends Model
{
    protected $table = 'kk_questions_answers';
    protected $primaryKey = 'kk_qa_id';

    const CREATED_AT = 'kk_qa_created_at';
    const UPDATED_AT = 'kk_qa_updated_at'; 
    ...
    {
        return $this->hasOne(KK_Questions_Users_Answers::class,  'kk_qua_answer_id', 'kk_qa_id');
    }
}
